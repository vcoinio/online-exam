...
import { Layout, Menu, Button, Icon, Tooltip, Select } from 'antd';
                    ...
                    >
                        {
                            this.props.user.userOptions.map((d, i) => {
                                return (
                                    <Menu.Item key={i}>
                                        <Icon type={d.icon} />
                                        <span>{this.props.t(d.display)}</span>
                                        <Link to={d.link}></Link>
                                    </Menu.Item>
                                )
                            })
                ...
                <Layout>
                    <Header theme="dark" style={{ position: 'fixed', width: '100vw', paddingLeft: '10px', zIndex: '1000' }}>
                        ...
                        <ul className="user-options-list">
                            <li style={{ marginRight: '15px' }}>
                                <Select value={this.props.i18n.language} style={{ width: 120 }} onChange={(val) => this.props.i18n.changeLanguage(val)}>
                                    <Option value="en">English</Option>
                                    <Option value="vi">Tiếng Việt</Option>
                                </Select>
                            </li>
                            <li>
                                <Tooltip placement="bottom" title={this.props.t('Log Out')}>
                    ...
                    <Content
                        style={{
                            ...
                            minHeight: '100vh',
                            marginLeft: this.state.collapsed ? '95px' : '220px',
