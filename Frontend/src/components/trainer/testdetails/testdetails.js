        ...
        Promise.all([p1, p2, p3, p4, p5]).then((response) => {
            ...
            if (response[0].data.success) {
                this.setState({
                    ...
                    stats: response[1].data.success ? response[1].data.data : [],
                    file: response[2].data.success ? response[2].data.file : null,
                    maxMarks: response[3].data.success ? response[3].data.data : 0,
                    loading: false,
                    feedbacks: response[4].data.success ? response[4].data.data : []
                })
            }
            else {
