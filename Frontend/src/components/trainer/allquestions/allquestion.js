    ...
    return (
      <div className="admin-table-container">
          ...
          <Row>
            <Col span={12}>
              <Button type="primary" icon="question-circle" style={{ marginBottom: '10px' }} onClick={() => this.openNewModal('Add New Question')}>
                {this.props.t('Add New Question')}
              </Button>
            </Col>
            <Col span={12}>
              <Select
                mode="multiple"
                placeholder={this.props.t('Select one or more subjects')}
        ...
        <div className="register-trainer-form-header">
          <Title level={4} style={{ color: '#fff', textAlign: 'center' }}>{this.props.t('List of Questions')}</Title>
        </div>
        <Table
          bordered={true}
          columns={columns}
        ...
        <Modal
          ...
          title={this.props.t('New Question')}
        ...
        <Modal
          ...
          title={this.props.t('Question Details')}
